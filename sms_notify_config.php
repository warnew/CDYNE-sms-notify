...
$sms_notifier_events['new_mention'] = 'Hey, somebody just mentioned you at oru forums!';
$sms_notifier_events['long_time_no_see'] = 'Long time no see! You should check in to our forums!';
